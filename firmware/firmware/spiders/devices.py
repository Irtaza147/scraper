import scrapy
import pandas as pd
from classroom.models import SearchData
class Spider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'FEED_URI': 'D:/University/FYP/ISPR-main/ISPR-main/ISPR_front_end/tmp_data.csv',  # Specify the file path to store the scraped data
    ...
    def parse_page(self, response):
        ...
        if self.callback:
            self.callback(data)  # Call the callback function with the scraped data
